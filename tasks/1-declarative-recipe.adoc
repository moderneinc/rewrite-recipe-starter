...
3. Open https://app.moderne.io[Moderne SaaS Marketplace] or the https://docs.openrewrite.org/recipes[Recipe Catalog] to identify recipe that helps to change the name of a method called
